...
import { footerList1, footerList2, footerList3, footerList4a, footerList4b, footerList5, socialIcons } from '../../Constant';
        ...
        <div>
            <div className='container-fluid footer'>
                <div className='row  '>
                    ...
                    <div className='col-md-2 column-2'>
                        <h6>For designers</h6>

                        <ul>
                            {footerList1.map((list) => {
                                return (
                                    <li>
                                        <a>{list.title}  </a>
                                    </li>
                    ...
                    <div className='col-md-2 column-5'>

                        <h6>Directories</h6>

                        <ul>
                            {footerList4a.map((list) => {
                                return (
                                    <li>
                                        <a>{list.title}  </a>
                                    </li>
                    ...
                    <div className='col-md-2 column-6'>

                        <h6>Design Resources</h6>

                        <ul>
                            {footerList5.map((list) => {
                                return (
                                    <li>
                                        <a>{list.title}  </a>
                                    </li>
                    ...
                    <div className='end-p '>
                        ...
                        <div className='right-end-p'>
                            <p><span> 22,381,714</span> shots dribbbled
                                <img src='https://cdn.dribbble.com/assets/dribbble-ball-icon-4e54c54abecf8efe027abe6f8bc7794553b8abef3bdb49cd15797067cf80ca53.svg' width={'24px'} />
                            </p>
